...
# Choose a frequency
frequency=$(zenity --title="PiFM by Mundeep Lamport" --entry --text="Choose a frequency (usually 87.5 - 108.0 MHz)" --entry-text="87.6" --width=500 --height=150 --ok-label="Continue" --cancel-label="Close")
...
zenity --title="PiFM by Mundeep Lamport" --info --text="Now that you have chosen your options, it is time to begin transmitting. Ensure your antenna is inserted into GPIO 4 and then click start." --ok-label="Start" --width=500 --height=150
